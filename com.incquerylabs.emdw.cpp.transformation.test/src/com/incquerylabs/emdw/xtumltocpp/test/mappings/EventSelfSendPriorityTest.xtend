...
class EventSelfSendPriorityTest extends TransformationTest<XTClass, CPPClass> {
	...
	override protected prepareCppModel(CPPModel cppModel) {
		...
		val xtComponent2 = xtPackage.entities.get(1) as XTComponent
		...
		val xtClass2 = xtComponent2.ownedClasses.head as XTClass
		createCPPClass(cppComponent2, xtClass2, null, null)

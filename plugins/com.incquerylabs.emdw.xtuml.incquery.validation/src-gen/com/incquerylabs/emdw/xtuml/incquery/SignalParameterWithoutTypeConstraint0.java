...
public class SignalParameterWithoutTypeConstraint0 implements IConstraintSpecification {

    private SignalParameterWithoutTypeQuerySpecification querySpecification;

    public SignalParameterWithoutTypeConstraint0() throws IncQueryException {
        querySpecification = SignalParameterWithoutTypeQuerySpecification.instance();
    }

    @Override
    public String getMessageFormat() {
        return "Parameter $parameter$ of signal $signal$ has no type";
    }

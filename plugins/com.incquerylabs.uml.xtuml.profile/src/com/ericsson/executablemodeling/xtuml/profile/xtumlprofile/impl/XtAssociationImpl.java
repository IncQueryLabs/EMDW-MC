...
import com.ericsson.executablemodeling.xtuml.profile.executablemodelingprofile.impl.XClassifierImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Xt Association</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.ericsson.executablemodeling.xtuml.profile.xtumlprofile.impl.XtAssociationImpl#getBase_Association <em>Base Association</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XtAssociationImpl extends XClassifierImpl implements XtAssociation {
	/**
	...
	protected EClass eStaticClass() {
		return xtUMLProfilePackage.Literals.XT_ASSOCIATION;
	}
		...
		if (base_Association != null && base_Association.eIsProxy()) {
			...
			if (base_Association != oldBase_Association) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, xtUMLProfilePackage.XT_ASSOCIATION__BASE_ASSOCIATION, oldBase_Association, base_Association));
			}
		}
	...
	public void setBase_Association(Association newBase_Association) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, xtUMLProfilePackage.XT_ASSOCIATION__BASE_ASSOCIATION, oldBase_Association, base_Association));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case xtUMLProfilePackage.XT_ASSOCIATION__BASE_ASSOCIATION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == XAssociation.class) {
			switch (derivedFeatureID) {
				case xtUMLProfilePackage.XT_ASSOCIATION__BASE_ASSOCIATION: return ExecutableModelingProfilePackage.XASSOCIATION__BASE_ASSOCIATION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == XAssociation.class) {
			switch (baseFeatureID) {
				case ExecutableModelingProfilePackage.XASSOCIATION__BASE_ASSOCIATION: return xtUMLProfilePackage.XT_ASSOCIATION__BASE_ASSOCIATION;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == XAssociation.class) {
			switch (baseOperationID) {
				case ExecutableModelingProfilePackage.XASSOCIATION___XASSOCIATION_IS_BINARY__DIAGNOSTICCHAIN_MAP: return xtUMLProfilePackage.XT_ASSOCIATION___XASSOCIATION_IS_BINARY__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case xtUMLProfilePackage.XT_ASSOCIATION___XASSOCIATION_IS_BINARY__DIAGNOSTICCHAIN_MAP:
				return xAssociationIsBinary((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case xtUMLProfilePackage.XT_ASSOCIATION___XT_ASSOCIATION_END_OWNERSHIP__DIAGNOSTICCHAIN_MAP:
				return xtAssociationEndOwnership((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case xtUMLProfilePackage.XT_ASSOCIATION___XT_ASSOCIATION_ENDS__DIAGNOSTICCHAIN_MAP:
				return xtAssociationEnds((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case xtUMLProfilePackage.XT_ASSOCIATION___XT_ASSOCIATION_END_TYPE__DIAGNOSTICCHAIN_MAP:
				return xtAssociationEndType((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case xtUMLProfilePackage.XT_ASSOCIATION___XT_ASSOCIATION_GENERALIZATION__DIAGNOSTICCHAIN_MAP:

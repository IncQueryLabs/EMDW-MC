...
import static com.incquerylabs.emdw.testing.common.wrappers.QueryResultTraceabilityWrapper.*
import com.ericsson.xtumlrt.oopl.cppmodel.CPPModel

class QueryResultTraceabilityWrapper extends TransformationWrapper {
